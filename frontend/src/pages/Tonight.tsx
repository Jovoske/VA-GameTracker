...
export default function Tonight() {
  ...
  return (
    <div style={{ maxWidth: 480, margin: '0 auto', padding: 16 }}>
      ...
      >
        <div style={{ fontWeight: 700, fontSize: 18 }}>Tonight</div>
        <button
          onClick={logout}
          style={{
            background: 'none',
      ...
      <div className="card" style={{ padding: 20, textAlign: 'center' }}>
        ...
        <div style={{ color: 'var(--text-dim)', fontSize: 14, lineHeight: 1.5, marginBottom: 16 }}>
          Once cameras are syncing, GameSense needs about 30 nights of data before the Tonight verdict
          (GO / MARGINAL / SKIP) becomes reliable. Nothing is faked before then.
        </div>
        <div style={{ height: 8, background: 'var(--surface-2)', borderRadius: 4, overflow: 'hidden' }}>
          <div style={{ width: '5%', height: '100%', background: 'var(--go)' }} />
        </div>
        <div style={{ color: 'var(--text-dim)', fontSize: 12, marginTop: 8 }}>0 of ~30 nights</div>
      </div>
